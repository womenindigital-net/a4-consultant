            ...
            <div class="card">
                <div class="card-body">
                    <div class="card p-2 mt-1">
                        <h3 class="text-primary">Create Service Category
                            <a href="{{route('service.category.list') }}"
                                class="btn btn-primary btn-sm text-white  float-end p-2"></i>Category Service List
                            </a>
                        </h3>
                    </div>
                    <hr>
                    <form action="{{ route('service.category.store') }}" method="POST" class="needs-validation" novalidate
