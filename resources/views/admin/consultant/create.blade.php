            ...
            <div class="card">
                <div class="card-body">
                    <div class="card p-2 mt-1">
                        <h3 class="text-primary">Create Consultant
                    ...
                    <hr>
                    <form action="{{ route('consultant.store') }}" method="POST" class="needs-validation" novalidate
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="consultantName" class="form-control" id="validationCustom02" >
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea name="consultantDesignation" class="form-control" rows="1"></textarea>
