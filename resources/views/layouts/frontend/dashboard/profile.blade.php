                        ...
                        <div class="row d-flex ">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input style="border-radius: 10px !important;" value="{{ $userInfo->name }}" type="text" name="name"
                            ...
                            <div class="col-6">
                                ...
                                <div class="mb-3 ">
                                    ...
                                    <input style="border-radius: 10px !important;" type="text" value="{{  $userInfo->email  }}" name="email"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/all/invoices/change-password') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="oldPasswordInput" style="color:#0081B5 !important;" class="form-label">Old Password</label>
                            ...
                            <div class="mb-3">
                                <label for="newPasswordInput" style="color:#0081B5 !important;" class="form-label">New Password</label>
                            ...
                            <div class="mb-1">
                                <label for="confirmNewPasswordInput" style="color:#0081B5 !important;" class="form-label ">Confirm New Password</label>
