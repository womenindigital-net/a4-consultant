...
<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <button type="button" class="btn btn-sm font-size-16 header-item"
                style="padding: 10px; color:#000 !important;" id="vertical-menu-btn">
            ...
            <div class="dash-menu">
                <ul class="d-flex align-items-center" style="padding-left:0px;">
                    ...
                    {{-- <li class="">
                        <a href="{{ route('clints') }}">Clints</a>
                    </li> --}}
                    <li class="">
                        <a href="{{ route('news') }}">Events</a>
                    </li>
                    <li class="">
                ...
                <div class="hidden fixed top-0 right-0 px-6 sm:block d-flex">
                    @auth
                        ...
                        <li type="button" data-bs-toggle="dropdown">
                            <a style="text-transform: uppercase; font-size:13px" type="button" class="nav-link dropdown-toggle fw-bold" href="#" id="navbarDropdown"
